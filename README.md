...
#### _Creates a Database with easy organizational tools for both tasks and categories, February 2016_

#### By _**Jason Wuerch**_

## Description

_This app allows the user to create tasks and categories for those tasks. It combines knowledge of PHP and MySQL using one-to-many relationships._
